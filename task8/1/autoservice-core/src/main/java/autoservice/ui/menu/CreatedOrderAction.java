...
public class CreatedOrderAction implements IAction{
    private static final Logger logger = LogManager.getLogger(CreatedOrderAction.class);
    ...
    @Override
    public void execute(){
        logger.info("Начало выполнения команды: создание нового заказа");
        ...
        try{
            ...
            logger.info("Заказ успешно создан: ID={}, Механик={}, Место={}", 
                orderId, mechId, slotId);
