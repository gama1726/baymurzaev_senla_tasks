...
public class ServiceOrder implements Serializable {
    ...
    /**
     * Метод для импорта: устанавливает статус и даты заказа.
     * Если статус не NEW, освобождает место в гараже.
     */
    public void setStatusAndDates(OrderStatus status, LocalDateTime submittedAt, LocalDateTime finishedAt) {
        this.status = status;
        if (submittedAt != null) {
        ...
        // Если статус не NEW, освобождаем место (так как при создании оно занялось)
